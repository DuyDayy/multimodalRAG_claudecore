...
from src.agents.query_decoupler import decouple_query
...
def build_graph():
    ...
    workflow.add_node("decoupler", decouple_query)
    ...
    workflow.add_edge("router", "decoupler")
    workflow.add_edge("decoupler", "retriever")
